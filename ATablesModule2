...
MC1 = Worksheets("PEC Calculator").Range("H7").Value 'Main categories
MC2 = Worksheets("PEC Calculator").Range("H10").Value
MC3 = Worksheets("PEC Calculator").Range("H13").Value
...
ElseIf tblA.Range(2, 2).Value = "TableA1.1" Then
    ...
    ElseIf MC1 = "3" Then
        ...
        tblA.Range(3, 2) = 0.05
        End If
    ElseIf Worksheets("PEC Calculator").Range("F7").Value = "Please Select" Then
...
ElseIf tblA.Range(2, 2).Value = "TableA1.2" Then 'For UC=33
    ...
    ElseIf MC1 = "1c" Then
        ...
        End If
    ElseIf Worksheets("PEC Calculator").Range("F7").Value = "Please Select" Or Worksheets("PEC Calculator").Range("F7").Value = "" Then
    tblA.Range(3, 2) = "Select main category for production"
    End If
...
ElseIf tblA.Range(2, 3).Value = "TableA2.1" Then
    ...
    ElseIf MC2 = "3" Then
        ...
        End If
    ElseIf Worksheets("PEC Calculator").Range("F10").Value = "Please Select" Or Worksheets("PEC Calculator").Range("F10").Value = "" Then
...
ElseIf tblA.Range(2, 4).Value = "TableA3.3" Then 'Chemical Industry only
    ...
    ElseIf MC3 = "3" Then
        ...
        tblA.Range(3, 4) = 0.05
        End If
    ElseIf Worksheets("PEC Calculator").Range("F13").Value = "Please Select" Or Worksheets("PEC Calculator").Range("F13").Value = "" Then
        tblA.Range(3, 4) = "Select main category for processing"
    End If
